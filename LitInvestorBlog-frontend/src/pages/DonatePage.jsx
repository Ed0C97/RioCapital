        ...
        <div className="flex justify-center pt-8 pb-32">
          <div className="text-center">
            ...
            >
              ...
              <span>
                {loading ? 'Elaborazione...' : `Dona Ora €${amount || '0'}`}
              </span>
            </Button>
                            ...
                            {paymentButtons.map((method) => {
                              ...
                              return (
                                <Label
                                  ...
                                  className={`flex items-center space-x-4 p-2 cursor-pointer rounded-md transition-colors duration-200 ${isSelected ? 'text-[#FBBC05] font-bold' : 'text-white hover:text-[#FBBC05] hover:font-bold'}`}
                                >
                                  <RadioGroupItem
                                    value={method.value}
                                    id={method.value}
                                  ...
                                  <div className="w-6 h-6 flex items-center justify-center">
                                    {isSelected && (
                                      <Check className="h-5 w-5 text-[#FBBC05]" />
                                    )}
                                  </div>
                      ...
                      <div className="space-y-6 mt-12">
                        ...
                        >
                          <div className="relative flex items-center justify-center h-5">
                            ...
                            />
                            <div className="w-4 h-4 bg-gray-700 border-gray-600 rounded transition-colors peer-checked:bg-[#0071e3] group-focus-within:ring-2 group-focus-within:ring-offset-2 group-focus-within:ring-offset-black group-focus-within:ring-[#0071e3]"></div>
                            <svg
                          ...
                          <div className="ms-3 text-sm">
                            ...
                            <p className="text-xs font-normal text-gray-400">
                              If selected, your name will not appear publicly.
                        ...
                        >
                          ...
                          <div className="ms-3 text-sm">
                            ...
                            <p className="text-xs font-normal text-gray-400">
                              By clicking, you confirm that you have read and
