...
const GlassCardForm = ({
  ...
  const currentMethodDetails = paymentButtons.find(
  ...
  const displayLogo =
    selectedMethod === 'card' ? (
      ...
      <Icon style={{ color: 'white', width: '48px', height: '48px' }} />
    ) : (
      <DefaultCardLogo />
    );
    ...
    <div className="payment-page-background">
      <div className="payment-form-wrapper">
        <div className="payment-module">
          ...
          <h1 className="title">
            Enter your optional details
            <br />
            or customise your amount
          </h1>
          <div className="card">
            ...
            <div className="absolute top-8 right-8">
              <div className="flex items-baseline justify-end">
                {customAmount.length < 7 ? (
                  <>
                    <span
                      className={`text-xl font-mono transition-colors duration-300 ${customAmount && parseFloat(customAmount) > 0 ? 'text-white' : 'text-white/50'}`}
                    >
                      €
                    </span>
                    <input
