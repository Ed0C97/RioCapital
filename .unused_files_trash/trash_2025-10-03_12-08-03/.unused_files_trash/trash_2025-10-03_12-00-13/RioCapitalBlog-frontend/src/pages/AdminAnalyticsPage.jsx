...
const AdminAnalyticsPage = () => {
  ...
  const { analytics, loading, error, fetchAnalytics, exportAnalytics } = useAnalytics(user);
  ...
  const overviewStats = [
    {
      ...
      color: 'text-blue-600',
      bgColor: 'bg-blue-100',
      growth: getGrowthPercentage(analytics.overview.totalArticles, analytics.overview.previousArticles)
    },
    {
      ...
      growth: getGrowthPercentage(analytics.overview.totalUsers, analytics.overview.previousUsers)
    },
    {
      title: 'Commenti',
      ...
      growth: getGrowthPercentage(analytics.overview.totalComments, analytics.overview.previousComments)
    },
    {
      title: 'Donazioni',
      ...
      growth: getGrowthPercentage(analytics.overview.totalRevenue, analytics.overview.previousRevenue)
    }
  ];
                  ...
                  <div>
                    ...
                    {stat.growth !== '0.0' && (
                      <div className={`flex items-center space-x-1 text-sm ${
                        parseFloat(stat.growth) > 0 ? 'text-green-600' : 'text-red-600'
                      }`}>
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">
                            di {article.author?.username} • {article.category?.name}
                          </p>
                        </div>
                      </div>
                    ...
                    {analytics.users.slice(0, 10).map((user, index) => (
                      <div key={user.id} className="flex items-center justify-between">
                        ...
                        <div className="text-sm text-muted-foreground">
                          {user.articles_count || 0} articoli • {user.comments_count || 0} commenti
                        </div>
                      </div>
                    ))}
                  </div>
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">{analytics.overview.totalDonations}</span>
                    </div>
                    <div className="flex justify-between">
                      <span>Importo medio:</span>
                      <span className="font-medium">
                        {formatCurrency(analytics.overview.totalRevenue / (analytics.overview.totalDonations || 1))}
                      </span>
                    </div>
                    <div className="flex justify-between">
