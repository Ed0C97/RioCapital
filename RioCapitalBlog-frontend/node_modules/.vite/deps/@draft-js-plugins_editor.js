...
var require_immutable = __commonJS({
  "../node_modules/@draft-js-plugins/editor/node_modules/immutable/dist/immutable.js"(exports, module) {
...
// ../node_modules/@draft-js-plugins/editor/lib/index.esm.js
...
function createEditorStateWithText$1(text) {
  if (import_draft_js.EditorState.createWithText) {
    return import_draft_js.EditorState.createWithText(text);
  }
  return import_draft_js.EditorState.createWithContent(import_draft_js.ContentState.createFromText(text));
}
...
function keyBindingFn(event) {
  return (0, import_draft_js.getDefaultKeyBinding)(event);
}
function handleKeyCommand(command, editorState, eventTimeStamp, _ref) {
  ...
  switch (command) {
    ...
    case "backspace-to-start-of-line":
      newState = import_draft_js.RichUtils.onBackspace(editorState);
      break;
    case "delete":
    case "delete-word":
    case "delete-to-end-of-block":
      newState = import_draft_js.RichUtils.onDelete(editorState);
      break;
    default:
      return "not-handled";
  }
  ...
  return function(block) {
    ...
    plugins.forEach(function(plugin) {
      ...
      if (result !== void 0 && result !== null) {
        var pluginProps = result.props, pluginRest = _objectWithoutPropertiesLoose(result, _excluded$1);
        var _resultBlock = resultBlock, props = _resultBlock.props, rest = _objectWithoutPropertiesLoose(_resultBlock, _excluded2);
...
function createPluginHooks(plugins, pluginFunction) {
  var pluginHooks = {};
  var handledAttributes = /* @__PURE__ */ new Set(["onChange"]);
  plugins.forEach(function(plugin) {
...
function createCompositeDecorator(decorators, getEditorState, setEditorState) {
  var convertedDecorators = (0, import_immutable.List)(decorators).map(function(decorator) {
    var Component2 = decorator.component;
    var DecoratedComponent = function DecoratedComponent2(props) {
  ...
  return new import_draft_js.CompositeDecorator(convertedDecorators);
}
var KEY_SEPARATOR = "-";
var MultiDecorator = (function() {
  function MultiDecorator2(decorators) {
    this.decorators = import_immutable.default.List(decorators);
  }
  var _proto = MultiDecorator2.prototype;
  _proto.getDecorations = function getDecorations(block, contentState) {
    ...
    return import_immutable.default.List(decorations);
  };
  _proto.getComponentForKey = function getComponentForKey(key) {
    var decorator = this.getDecoratorForKey(key);
    return decorator.getComponentForKey(MultiDecorator2.getInnerKey(key));
  };
  _proto.getPropsForKey = function getPropsForKey(key) {
    var decorator = this.getDecoratorForKey(key);
    return decorator.getPropsForKey(MultiDecorator2.getInnerKey(key));
  };
  ...
  MultiDecorator2.getInnerKey = function getInnerKey(key) {
    var parts = key.split(KEY_SEPARATOR);
    return parts.slice(1).join(KEY_SEPARATOR);
  };
  return MultiDecorator2;
})();
var decoratorIsCustom = function decoratorIsCustom2(decorator) {
...
var getDecoratorsFromProps = function getDecoratorsFromProps2(_ref) {
  var decorators = _ref.decorators, _ref$plugins = _ref.plugins, plugins = _ref$plugins === void 0 ? [] : _ref$plugins;
  return (0, import_immutable.List)([{
    decorators
  }].concat(plugins)).filter(function(plugin) {
    return (plugin == null ? void 0 : plugin.decorators) !== void 0;
...
var getDecoratorLength = function getDecoratorLength2(obj) {
...
var PluginEditor = (function(_Component) {
  _inheritsLoose(PluginEditor2, _Component);
  function PluginEditor2(_props) {
    var _this;
    ...
    _this.resolveCustomStyleMap = function() {
      var customStyleMap = _this.props.plugins.filter(function(plug) {
        return plug.customStyleMap !== void 0;
      }).map(function(plug) {
    ...
    _this.resolveblockRenderMap = function() {
      var blockRenderMap = _this.props.plugins.filter(function(plug) {
        return plug.blockRenderMap !== void 0;
      }).reduce(function(maps, plug) {
        return maps.merge(plug.blockRenderMap);
      }, (0, import_immutable.Map)({}));
      if (_this.props.defaultBlockRenderMap) {
        blockRenderMap = import_draft_js.DefaultDraftBlockRenderMap.merge(blockRenderMap);
      }
  ...
  var _proto = PluginEditor2.prototype;
  ...
  _proto.componentDidMount = function componentDidMount() {
    ...
    var editorState = import_draft_js.EditorState.set(this.props.editorState, {
      decorator
    });
    this.onChange(import_draft_js.EditorState.moveSelectionToEnd(editorState));
  };
  _proto.componentDidUpdate = function componentDidUpdate(prevProps) {
    ...
    var editorState = import_draft_js.EditorState.set(next.editorState, {
      decorator: currDec
    });
    this.onChange(import_draft_js.EditorState.moveSelectionToEnd(editorState));
  };
  ...
  _proto.render = function render() {
    ...
    return import_react.default.createElement(import_draft_js.Editor, _extends({}, editorProps, accessibilityProps, pluginHooks, {
  ...
  return PluginEditor2;
})(import_react.Component);
PluginEditor.propTypes = {
  editorState: import_prop_types.default.object.isRequired,
  onChange: import_prop_types.default.func.isRequired,
  plugins: import_prop_types.default.array,
  defaultKeyBindings: import_prop_types.default.bool,
  defaultKeyCommands: import_prop_types.default.bool,
  defaultBlockRenderMap: import_prop_types.default.bool,
  customStyleMap: import_prop_types.default.object,
  // eslint-disable-next-line react/no-unused-prop-types
  decorators: import_prop_types.default.array
};
...
//# sourceMappingURL=@draft-js-plugins_editor.js.map
