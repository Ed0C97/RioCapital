...
// ../node_modules/@draft-js-plugins/buttons/lib/index.esm.js
var import_react = __toESM(require_react());

// ../node_modules/@draft-js-plugins/buttons/node_modules/clsx/dist/clsx.m.js
function r(e) {
  var t, f, n = "";
...
function createBlockAlignmentButton(_ref) {
  var alignment = _ref.alignment, children = _ref.children;
  return function BlockAlignmentButton(props) {
    var activate = function activate2(event) {
      event.preventDefault();
      props.setAlignment({
        alignment
      });
    };
    var preventBubblingUp = function preventBubblingUp2(event) {
      event.preventDefault();
    };
    var isActive = function isActive2() {
      return props.alignment === alignment;
    };
    var theme = props.theme, _props$buttonProps = props.buttonProps, buttonProps = _props$buttonProps === void 0 ? {} : _props$buttonProps;
    var className = isActive() ? clsx_m_default(theme.button, theme.active) : theme.button;
    return import_react.default.createElement("div", {
      className: theme.buttonWrapper,
      onMouseDown: preventBubblingUp
    }, import_react.default.createElement("button", _extends({
      children
    }, buttonProps, {
      className,
      onClick: activate,
...
var AlignBlockCenterButton = createBlockAlignmentButton({
  alignment: "center",
  children: import_react.default.createElement("svg", {
    height: "24",
    viewBox: "0 0 24 24",
    width: "24",
...
function createTextAlignmentButton(_ref) {
  ...
  return function InlineStyleButton(props) {
    var toggleStyle = function toggleStyle2(event) {
      ...
      var modifiedContent = import_draft_js.Modifier.applyInlineStyle(currentContent, selectWholeBlocks, alignment);
      var finalContent = removeStyles.reduce(function(content, style) {
        return import_draft_js.Modifier.removeInlineStyle(content, selectWholeBlocks, style);
      }, modifiedContent);
      var nextEditorState = import_draft_js.EditorState.push(currentEditorState, finalContent, "change-inline-style");
      props.setEditorState(nextEditorState);
    };
    var preventBubblingUp = function preventBubblingUp2(event) {
      event.preventDefault();
    };
    var styleIsActive = function styleIsActive2() {
      return props.getEditorState && props.getEditorState().getCurrentInlineStyle().has(alignment);
    };
    var theme = props.theme, _props$buttonProps = props.buttonProps, buttonProps = _props$buttonProps === void 0 ? {} : _props$buttonProps;
    var className = styleIsActive() ? clsx_m_default(theme.button, theme.active) : theme.button;
    return import_react.default.createElement("div", {
      className: theme.buttonWrapper,
      onMouseDown: preventBubblingUp
    }, import_react.default.createElement("button", _extends({
...
function createBlockStyleButton(_ref) {
  var blockType = _ref.blockType, children = _ref.children;
  return function BlockStyleButton(props) {
    var toggleStyle = function toggleStyle2(event) {
      event.preventDefault();
      props.setEditorState(import_draft_js.RichUtils.toggleBlockType(props.getEditorState(), blockType));
    };
    var preventBubblingUp = function preventBubblingUp2(event) {
      event.preventDefault();
    };
    var blockTypeIsActive = function blockTypeIsActive2() {
    ...
    var theme = props.theme, _props$buttonProps = props.buttonProps, buttonProps = _props$buttonProps === void 0 ? {} : _props$buttonProps;
    var className = blockTypeIsActive() ? clsx_m_default(theme.button, theme.active) : theme.button;
    return import_react.default.createElement("div", {
      className: theme.buttonWrapper,
      onMouseDown: preventBubblingUp
    }, import_react.default.createElement("button", _extends({
...
function createInlineStyleButton(_ref) {
  ...
  return function InlineStyleButton(props) {
    var toggleStyle = function toggleStyle2(event) {
      event.preventDefault();
      props.setEditorState(import_draft_js.RichUtils.toggleInlineStyle(props.getEditorState(), style));
    };
    var preventBubblingUp = function preventBubblingUp2(event) {
      event.preventDefault();
    };
...
var SubButton = createInlineStyleButton({
  style: "SUBSCRIPT",
  children: import_react.default.createElement("div", null, "x", import_react.default.createElement("sub", null, "2"))
});
var SupButton = createInlineStyleButton({
  style: "SUPERSCRIPT",
  children: import_react.default.createElement("div", null, "x", import_react.default.createElement("sup", null, "2"))
});
...
//# sourceMappingURL=chunk-KHYSWFGY.js.map
