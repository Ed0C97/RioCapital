...
const Highlight = ({ text, matches, matchKey }) => {
  ...
  indices.forEach(([start, end], i) => {
    ...
    highlighted.push(
      <strong key={`m-${i}`} className="text-gray-900 font-semibold group-hover:text-blue-600">
...
const SearchResultsDropdown = ({ results, onResultClick, isExpandedView = false }) => {
  ...
  if (isExpandedView) {
    return (
      <div>
        <h3 className="text-xs font-regular text-gray-500 mb-3">Suggerimenti</h3>
