...
const ExpandingSearchBar = () => {
  ...
  useEffect(() => {
    ...
    const shouldShowDropdown = isExpanded && results.length > 0 && isDropdownVisible;
  ...
  return (
    <div className="relative flex items-center" ref={searchBarRef}>
      ...
      <div className={`transition-all duration-300 ${isExpanded ? 'w-64 opacity-100 ml-2' : 'w-0 opacity-0'}`}>
      ...
      <SearchResultsDropdown results={results} rect={dropdownRect} onResultClick={handleResultClick} />
    </div>
  );
};
