  ...
  if (!user) {
    return (
      <div className="container mx-auto px-4 py-8 text-center">
        ...
        <p className="text-muted-foreground">Devi accedere per vedere i tuoi articoli piaciuti.</p>
      </div>
    );
  }
    ...
    <div className="bg-white">
      <div className="w-full mb-12">
        <div className="max-w-[1012px] mx-auto px-[16px] sm:px-[16px] lg:px-[16px] pt-12">
          ...
          <h2 className="text-2xl font-regular text-gray-500">Articoli che ti piacciono</h2>
        </div>
      </div>
        ...
        {likedArticles.length > 0 ? (
          ...
          filteredArticles.length > 0 ? (
            ...
            <div className="text-center py-12">
              <p className="text-gray-500">Nessun articolo trovato per "{searchTerm}".</p>
            </div>
          )
        ) : (
          <div className="text-center py-12 border-t border-gray-200">
            <Heart className="w-12 h-12 text-gray-400 mx-auto mb-4" />
            <h3 className="text-xl font-semibold text-gray-800">Nessun "mi piace" ancora</h3>
            <p className="text-gray-500">Gli articoli a cui metti "mi piace" appariranno qui.</p>
          </div>
        )}
        {/* ------------------------------------------- */}
      </div>
