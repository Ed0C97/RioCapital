    ...
    <div className="bg-white">
      ...
      <div className="w-full mb-16">
        <div className="max-w-[1012px] mx-auto px-[16px] sm:px-[16px] lg:px-[16px] pt-12">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <h2 className="text-2xl font-regular text-gray-500">Page Not Found</h2>
      ...
      <div className="max-w-[1012px] mx-auto px-[16px] text-center mb-16">
        ...
        <p className="text-lg text-gray-500 max-w-3xl mx-auto mb-8">
          The page at <strong className="text-[#3b82f6] font-medium">{location.pathname}</strong> could not be found.
          Don't worry, you can use the tools below to get back on track.
        </p>
      ...
      <div className="bg-gray-50 border-y border-gray-200">
        <div className="max-w-[1012px] mx-auto px-[16px] py-20">
          <h3 className="text-3xl font-semibold text-gray-800 text-center mb-12">Popular Pages</h3>
      ...
      <div className="bg-white">
        <div className="max-w-[1012px] mx-auto px-[16px] py-16 text-center">
          ...
          <h3 className="text-2xl font-semibold text-gray-800 mb-2">Still can't find what you're looking for?</h3>
