            ...
            <CardContent className="p-0">
              <Elements stripe={stripePromise}>
                <DonationFormWrapper
                  ...
                  paymentMethod={paymentMethod} // <-- AGGIUNGI QUESTA RIGA
                >
                    ...
                    <div className="relative min-h-[450px]">
                      <div className="absolute top-0 left-95 w-[73%] z-10 -translate-y-10">
                        <GlassCardForm
                          ...
                          donorInfo={donorInfo}
                          onDonorInfoChange={handleInputChange} // Usiamo la funzione che già esiste!
                          cardType={cardType}
                  ...
                  <div className="space-y-6 mt-36">
                    ...
                    {/* Blocco di anteprima del messaggio che appare solo se il messaggio esiste */}
                    {donorInfo.message && (
