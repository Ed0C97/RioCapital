...
const AboutPage = () => {
  ...
  const getDefaultContent = () => {
    return `FinBlog è la tua fonte di riferimento per informazioni finanziarie accurate, analisi di mercato approfondite e consigli pratici per la gestione del denaro.
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
          Scopri la storia, la missione e il team dietro FinBlog
        </p>
      </div>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between">
            <div>
              ...
              <CardDescription>
                Scopri come è nato FinBlog e qual è la nostra missione
              </CardDescription>
            </div>
            {isAdmin() && !isEditing && (
            ...
            <Card key={index}>
              <CardContent className="pt-6">
                <div className="flex items-start space-x-4">
                  <div className="w-16 h-16 finblog-gradient rounded-full flex items-center justify-center text-white font-bold text-lg">
                    {member.avatar}
                  </div>
